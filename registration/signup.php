...
<br>
					...
					<div class="wrap-input100 validate-input" >
						<span class="label-input100">Пароль</span>
						<input class="input100" type="password_2" name="password_2" placeholder="123" value="<?php echo @$data['password_2']; ?>">
						<span class="focus-input100"></span>
					</div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCR_AlPtExtYwFx3CkqOJICSQ_0rhED-UE&amp;amp;amp;sensor=false"></script>
